...
import com.gachapon.service.SuperUserLoginService;
...
public class SuperUserContoroller {
	...
	SuperUserLoginService loginService;
	...
	public String displaySuperUserIndex(){
	...
	public String login(
		...
		Account account = loginService.findSuperUser(form); // サービスクラスからアカウント情報を取得
